...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7098250905:AAGG7jodibyudPc49c-sWU3beIUunvOJoK0")
APP_ID = int(os.environ.get("APP_ID", "21016163"))
API_HASH = os.environ.get("API_HASH", "365f3421c4243310e1c738e2b6fb63a1")


OWNER = os.environ.get("OWNER", "https://t.me/Jack_AFO") #Owner username
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002063266681"))
...
START_MSG = os.environ.get("START_MESSAGE", "Hello {mention}✨\n\nI am a file store bot Powered by @Anime_Carnival_4U ⚡.")
